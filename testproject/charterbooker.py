...
# TC2 email validation. wrong email test data: kis.laci@valami@valami.com
    ...
    #error_message_text = driver.find_element_by_xpath('//*[@id="bf_email-error"]').text
    error_message_text = driver.find_element_by_id("bf_email-error").text
    #print(error_message_text)
    message = "Please enter a valid email address."
    #print(message)
    assert error_message_text == message.upper()
    time.sleep(1)
